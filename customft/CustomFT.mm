...
- (void)addTableCell {
    [self presentViewController:[BTOAddShortCutViewController new] animated:YES completion:nil];
}
- (void)options {
	[self presentViewController:[BTOOptionsViewController new] animated:YES completion:nil];
}
- (void)donate {
